...
final class L10n: ObservableObject {
    ...
    private static let dict: [AppLanguage: [String: String]] = [
        .en: [
            ...
            "alert.ok": "OK",
            "alert.hooksInstalledDefaultMsg": "Cursor and Claude Code hooks registered. Reload Cursor to activate.",
        ...
        .zh: [
            ...
            "alert.ok": "好",
            "alert.hooksInstalledDefaultMsg": "已注册 Cursor 与 Claude Code 的 hooks，重新加载 Cursor 即可生效。",
